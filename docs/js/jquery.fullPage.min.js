...
!function (e, n) {
...
}("undefined" != typeof window ? window : undefined, function (e, n, o, t, i) {
  "use strict";
  var l,
      a = "fullpage-wrapper",
      r = "." + a,
      ...
      ne = j + _,
      oe = e(n),
      te = e(o);e.fn.fullpage = function (s) {
    function c() {
      s.css3 && (s.css3 = mn()), s.scrollBar = s.scrollBar || s.hybrid, d(), K(), Hn.setAllowScrolling(!0), Wn = oe.height(), Hn.setAutoScrolling(s.autoScrolling, "internal");var n = e(b).find(D);n.length && (0 !== e(b).index(x) || 0 === e(b).index(x) && 0 !== n.index()) && Tn(n), je(), vn(), oe.on("load", function () {
        Fe();
      });
    }function f() {
      ...
      Vn.css({ height: "100%", position: "relative" }), Vn.addClass(a), e("html").addClass(v), Vn.removeClass(h), ie(), e(x).each(function (n) {
        var o = e(this),
            t = o.find(z),
            i = t.length;$(o, n), _(o, n), i > 0 ? G(o, t, i) : s.verticalCentered && tn(o);
      ...
      var i = 100 * t,
          l = 100 / t;o.wrapAll('<div class="' + V + '" />'), o.parent().wrap('<div class="' + I + '" />'), n.find(W).css("width", i + "%"), t > 1 && (s.controlArrows && le(n), s.slidesNavigation && dn(n, t)), o.each(function (n) {
        e(this).css("width", l + "%"), s.verticalCentered && tn(e(this));
      });var a = n.find(D);a.length && (0 !== e(b).index(x) || 0 === e(b).index(x) && 0 !== a.index()) ? Tn(a) : o.eq(0).addClass(g);
    }function $(n, o) {
      ...
      Fn.append('<div id="' + L + '"><ul></ul></div>');var n = e(E);n.addClass(function () {
        ...
        var t = "";s.anchors.length && (t = s.anchors[o]);var i = '<li><a href="#' + t + '"><span></span></a>',
            l = s.navigationTooltips[o];"undefined" != typeof l && "" !== l && (i += '<div class="' + R + " " + s.navigationPosition + '">' + l + "</div>"), i += "</li>", n.find("ul").append(i);
      ...
      var n = e(b);n.addClass("completely"), s.scrollOverflowHandler.afterRender && s.scrollOverflowHandler.afterRender(n), Me(n), Le(n), e.isFunction(s.afterLoad) && s.afterLoad.call(n, n.data("anchor"), n.index(x) + 1), e.isFunction(s.afterRender) && s.afterRender.call(Vn);
    }function ce() {
      var n;if (!s.autoScrolling || s.scrollBar) {
        for (var t = oe.scrollTop(), i = de(t), l = 0, a = t + oe.height() / 2, r = o.querySelectorAll(x), c = 0; c < r.length; ++c) {
          ...
          eo = !0;var d = e(b),
              ...
              h = n.data("anchor"),
              v = n.index(x) + 1,
              m = n.find(D);if (m.length) var S = m.data("anchor"),
              w = m.index();Xn && (n.addClass(g).siblings().removeClass(g), e.isFunction(s.onLeave) && s.onLeave.call(d, u, v, p), e.isFunction(s.afterLoad) && s.afterLoad.call(n, h, v), Me(n), _e(h, v - 1), s.anchors.length && (qn = h, un(w, S, h, v))), clearTimeout(Jn), Jn = setTimeout(function () {
            eo = !1;
          }, 100);
      ...
      var o = e(b).position().top,
          t = o + oe.height();return "up" == n ? t >= oe.scrollTop() + oe.height() : o <= oe.scrollTop();
    }function de(e) {
      var n = e > no ? "down" : "up";return no = e, n;
    }function ue(e, n) {
      if (Kn.m[e]) {
        var o, t;if ("down" == e ? (o = "bottom", t = Hn.moveSectionDown) : (o = "top", t = Hn.moveSectionUp), n.length > 0) {
          if (!s.scrollOverflowHandler.isScrolled(o, n)) return !0;t();
        } else t();
      }
    }function pe(n) {
      var o = n.originalEvent;if (!he(n.target) && ve(o)) {
        s.autoScrolling && n.preventDefault();var i = e(b),
            l = s.scrollOverflowHandler.scrollable(i);if (Xn && !Dn) {
          var a = bn(o);io = a.y, lo = a.x, i.find(P).length && t.abs(to - lo) > t.abs(oo - io) ? t.abs(to - lo) > oe.outerWidth() / 100 * s.touchSensitivity && (to > lo ? Kn.m.right && Hn.moveSlideRight() : Kn.m.left && Hn.moveSlideLeft()) : s.autoScrolling && t.abs(oo - io) > oe.height() / 100 * s.touchSensitivity && (oo > io ? ue("down", l) : io > oo && ue("up", l));
        }
      }
    }function he(n, o) {
      o = o || 0;var t = e(n).parent();return o < s.normalScrollElementTouchThreshold && t.is(s.normalScrollElements) ? !0 : o == s.normalScrollElementTouchThreshold ? !1 : he(t, ++o);
    }function ve(e) {
      return "undefined" == typeof e.pointerType || "mouse" != e.pointerType;
    }function me(e) {
      var n = e.originalEvent;if (s.fitToSection && Rn.stop(), ve(n)) {
        var o = bn(n);oo = o.y, to = o.x;
      }
    }function ge(e, n) {
      ...
      var i = new Date().getTime(),
          l = e(".completely").hasClass(M);if (s.autoScrolling && !zn && !l) {
        o = o || n.event;var a = o.wheelDelta || -o.deltaY || -o.detail,
            r = t.max(-1, t.min(1, a)),
            c = "undefined" != typeof o.wheelDeltaX || "undefined" != typeof o.deltaX,
            f = t.abs(o.wheelDeltaX) < t.abs(o.wheelDelta) || t.abs(o.deltaX) < t.abs(o.deltaY) || !c;Nn.length > 149 && Nn.shift(), Nn.push(t.abs(a)), s.scrollBar && (o.preventDefault ? o.preventDefault() : o.returnValue = !1);var d = e(b),
            u = s.scrollOverflowHandler.scrollable(d),
            p = i - ao;if (ao = i, p > 200 && (Nn = []), Xn) {
          var h = ge(Nn, 10),
              v = ge(Nn, 70),
              m = h >= v;m && f && (0 > r ? ue("down", u) : ue("up", u));
        }return !1;
      }s.fitToSection && Rn.stop();
    }function we(n, o) {
      var t = "undefined" == typeof o ? e(b) : o,
          i = t.find(P),
          l = i.find(z).length;if (!(!i.length || Dn || 2 > l)) {
        var a = i.find(D),
            r = null;if (r = "prev" === n ? a.prev(z) : a.next(z), !r.length) {
          if (!s.loopHorizontal) return;r = "prev" === n ? a.siblings(":last") : a.siblings(":first");
        }Dn = !0, Ne(i, r);
      }
    }function ye() {
      e(D).each(function () {
      ...
      var o = e.top;return e.top > ro && (o = o - Wn + n.outerHeight()), ro = o, o;
    }function be(n, o, t) {
      requestAnimFrame(function () {
        var i = n.position();if ("undefined" != typeof i) {
          var l = xe(i, n),
              a = { element: n, callback: o, isMovementUp: t, dest: i, dtop: l, yMovement: en(n), anchorLink: n.data("anchor"), sectionIndex: n.index(x), activeSlide: n.find(D), activeSection: e(b), leavingSection: e(b).index(x) + 1, localIsResizing: Yn };if (!(a.activeSection.is(n) && !Yn || s.scrollBar && oe.scrollTop() === a.dtop && !n.hasClass(B))) {
            if (a.activeSlide.length) var r = a.activeSlide.data("anchor"),
                c = a.activeSlide.index();s.autoScrolling && s.continuousVertical && "undefined" != typeof a.isMovementUp && (!a.isMovementUp && "up" == a.yMovement || a.isMovementUp && "down" == a.yMovement) && (a = ke(a)), (!e.isFunction(s.onLeave) || a.localIsResizing || s.onLeave.call(a.activeSection, a.leavingSection, a.sectionIndex + 1, a.yMovement) !== !1) && (Ee(a.activeSection), n.addClass(g).siblings().removeClass(g), Me(n), Xn = !1, un(c, r, a.anchorLink, a.sectionIndex), Te(a), qn = a.anchorLink, _e(a.anchorLink, a.sectionIndex));
          }
        }
      });
    }function Te(n) {
      if (s.css3 && s.autoScrolling && !s.scrollBar) {
        var o = "translate3d(0px, -" + n.dtop + "px, 0px)";an(o, !0), s.scrollingSpeed ? Qn = setTimeout(function () {
          Be(n);
        }, s.scrollingSpeed) : Be(n);
      } else {
        var t = Ce(n);e(t.element).animate(t.options, s.scrollingSpeed, s.easing).promise().done(function () {
      ...
      var n = Re(n);n.find("img[data-src], source[data-src], audio[data-src]").each(function () {
        e(this).attr("src", e(this).data("src")), e(this).removeAttr("data-src"), e(this).is("source") && e(this).closest("video").get(0).load();
      });
    }function Le(n) {
      var n = Re(n);n.find("video, audio").each(function () {
      ...
      var o = n.find(D);return o.length && (n = e(o)), n;
    }function Fe() {
      var e = n.location.hash.replace("#", "").split("/"),
          o = e[0],
          t = e[1];o && (s.animateAnchor ? cn(o, t) : Hn.silentMoveTo(o, t));
    }function He() {
      if (!eo && !s.lockAnchors) {
        var e = n.location.hash.replace("#", "").split("/"),
            o = e[0],
            ...
            l = "undefined" == typeof qn && "undefined" == typeof t && !Dn;o.length && (o && o !== qn && !i || l || !Dn && On != t) && cn(o, t);
      }
    }function qe(n) {
      clearTimeout($n);var o = e(":focus");if (!o.is("textarea") && !o.is("input") && !o.is("select") && s.keyboardScrolling && s.autoScrolling) {
        var t = n.which,
            i = [40, 38, 32, 33, 34];e.inArray(t, i) > -1 && n.preventDefault(), zn = n.ctrlKey, $n = setTimeout(function () {
          Ue(n);
        }, 150);
      }
    }function Oe() {
      ...
      var n = e(this).closest(x);e(this).hasClass(Q) ? Kn.m.left && Hn.moveSlideLeft(n) : Kn.m.right && Hn.moveSlideRight(n);
    }function Ve() {
      Un = !1, zn = !1;
    }function We(n) {
      n.preventDefault();var o = e(this).parent().index();be(e(x).eq(o));
    }function Ye(n) {
      n.preventDefault();var o = e(this).closest(x).find(P),
          t = o.find(z).eq(e(this).closest("li").index());Ne(o, t);
    }function Ue(n) {
      var o = n.shiftKey;switch (n.which) {case 38:case 33:
          Kn.k.up && Hn.moveSectionUp();break;case 32:
          if (o && Kn.k.up) {
            Hn.moveSectionUp();break;
          }case 40:case 34:
          Kn.k.down && Hn.moveSectionDown();break;case 36:
          Kn.k.up && Hn.moveTo(1);break;case 35:
          Kn.k.down && Hn.moveTo(e(x).length);break;case 37:
          Kn.k.left && Hn.moveSlideLeft();break;case 39:
          Kn.k.right && Hn.moveSlideRight();break;default:
          return;}
    }function Xe(e) {
      ...
      var i = o.position(),
          ...
          d = hn(o),
          u = a.find(D),
          p = Yn;if (s.onSlideLeave) {
        var h = u.index(),
            v = nn(h, l);if (!p && "none" !== v && e.isFunction(s.onSlideLeave) && s.onSlideLeave.call(u, c, r + 1, h, v, l) === !1) return void (Dn = !1);
      }Ee(u), o.addClass(g).siblings().removeClass(g), p || Me(o), !s.loopHorizontal && s.controlArrows && (a.find(Z).toggle(0 !== l), a.find(ne).toggle(!o.is(":last-child"))), a.hasClass(g) && un(l, d, c, r);var m = function m() {
        p || e.isFunction(s.afterSlideLoad) && s.afterSlideLoad.call(o, c, r + 1, d, l), Le(o), Dn = !1;
      };if (s.css3) {
        var w = "translate3d(-" + t.round(i.left) + "px, 0px, 0px)";Qe(n.find(W), s.scrollingSpeed > 0).css(kn(w)), Gn = setTimeout(function () {
          m();
      ...
      if (je(), In) {
        var n = e(o.activeElement);if (!n.is("textarea") && !n.is("input") && !n.is("select")) {
          var i = oe.height();t.abs(i - co) > 20 * t.max(co, i) / 100 && (Hn.reBuild(!0), co = i);
        }
      ...
      var e = s.responsive || s.responsiveWidth,
          ...
          o = e && oe.outerWidth() < e,
          t = n && oe.height() < n;e && n ? Hn.setResponsive(o || t) : e ? Hn.setResponsive(o) : n && Hn.setResponsive(t);
    }function Qe(e) {
      var n = "all " + s.scrollingSpeed + "ms " + s.easingcss3;return e.removeClass(p), e.css({ "-webkit-transition": n, transition: n });
    }function Ge(e) {
      return e.addClass(p);
    }function Je(e, n) {
      var o = 825,
        ...
        var l = 100 * e / o,
            a = 100 * n / i,
            r = t.min(l, a),
            s = r.toFixed(2);Fn.css("font-size", s + "%");
      ...
      var o = e(b).index(x),
          t = n.index(x);return o == t ? "none" : o > t ? "up" : "down";
    }function nn(e, n) {
      ...
      var o = Vn.find(x + '[data-anchor="' + n + '"]');return o.length || (o = e(x).eq(n - 1)), o;
    }function sn(e, n) {
      var o = n.find(P),
          t = o.find(z + '[data-anchor="' + e + '"]');return t.length || (t = o.find(z).eq(e)), t;
    }function cn(e, n) {
      var o = rn(e);"undefined" == typeof n && (n = 0), e === qn || o.hasClass(g) ? fn(o, n) : be(o, function () {
        fn(o, n);
      });
    }function fn(e, n) {
      if ("undefined" != typeof n) {
        var o = e.find(P),
            t = sn(n, e);t.length && Ne(o, t);
      }
    }function dn(e, n) {
      e.append('<div class="' + U + '"><ul></ul></div>');var o = e.find(X);o.addClass(s.slidesNavPosition);for (var t = 0; n > t; t++) {
        o.find("ul").append('<li><a href="#"><span></span></a></li>');
      }o.css("margin-left", "-" + o.width() / 2 + "px"), o.find("li").first().find("a").addClass(g);
    }function un(e, n, o, t) {
      var i = "";s.anchors.length && !s.lockAnchors && (e ? ("undefined" != typeof o && (i = o), "undefined" == typeof n && (n = e), On = n, pn(i + "/" + n)) : "undefined" != typeof e ? (On = n, pn(o)) : pn(o)), vn();
    }function pn(e) {
      ...
      var n = e(b),
          ...
          t = hn(n),
          i = hn(o),
          l = (n.index(x), String(t));o.length && (l = l + "-" + i), l = l.replace("/", "-").replace("#", "");var a = new RegExp("\\b\\s?" + m + "-[^\\s]+\\b", "g");Fn[0].className = Fn[0].className.replace(a, ""), Fn.addClass(m + "-" + l);
    }function mn() {
      var e,
          t = o.createElement("p"),
          l = { webkitTransform: "-webkit-transform", OTransform: "-o-transform", msTransform: "-ms-transform", MozTransform: "-moz-transform", transform: "transform" };o.body.insertBefore(t, null);for (var a in l) {
        t.style[a] !== i && (t.style[a] = "translate3d(1px,1px,1px)", e = n.getComputedStyle(t).getPropertyValue(l[a]));
      ...
      var e,
          t = "";n.addEventListener ? e = "addEventListener" : (e = "attachEvent", t = "on");var l = "onwheel" in o.createElement("div") ? "wheel" : o.onmousewheel !== i ? "mousewheel" : "DOMMouseScroll";"DOMMouseScroll" == l ? o[e](t + "MozMousePixelScroll", Se, !1) : o[e](t + l, Se, !1);
    }function wn() {
      if (In || Pn) {
        var n = xn();e(r).off("touchstart " + n.down).on("touchstart " + n.down, me), e(r).off("touchmove " + n.move).on("touchmove " + n.move, pe);
      }
    }function yn() {
      if (In || Pn) {
        var n = xn();e(r).off("touchstart " + n.down), e(r).off("touchmove " + n.move);
      }
    }function xn() {
      var e;return e = n.PointerEvent ? { down: "pointerdown", move: "pointermove" } : { down: "MSPointerDown", move: "MSPointerMove" };
    }function bn(e) {
      var n = [];return n.y = "undefined" != typeof e.pageY && (e.pageY || e.pageX) ? e.pageY : e.touches[0].pageY, n.x = "undefined" != typeof e.pageX && (e.pageY || e.pageX) ? e.pageX : e.touches[0].pageX, Pn && ve(e) && s.scrollBar && (n.y = e.touches[0].pageY, n.x = e.touches[0].pageX), n;
    }function Tn(e, n) {
      ...
      if (s.scrollBar) Vn.scrollTop(e);else if (s.css3) {
        var n = "translate3d(0px, -" + e + "px, 0px)";an(n, !1);
      } else Vn.css("top", -e);
    }function kn(e) {
      return { "-webkit-transform": e, "-moz-transform": e, "-ms-transform": e, transform: e };
    }function An(e, n, o) {
      switch (n) {case "up":
          Kn[o].up = e;break;case "down":
          Kn[o].down = e;break;case "left":
          Kn[o].left = e;break;case "right":
          Kn[o].right = e;break;case "all":
          "m" == o ? Hn.setAllowScrolling(e) : Hn.setKeyboardScrolling(e);}
    }function Bn() {
      Cn(0), e(E + ", " + X + ", " + j).remove(), e(x).css({ height: "", "background-color": "", padding: "" }), e(z).css({ width: "" }), Vn.css({ height: "", position: "", "-ms-touch-action": "", "touch-action": "" }), Rn.css({ overflow: "", height: "" }), e("html").removeClass(v), e.each(Fn.get(0).className.split(/\s+/), function (e, n) {
      ...
      }), Rn.scrollTop(0);var n = [y, O, V];e.each(n, function (n, o) {
        e("." + o).removeClass(o);
      });
    }function Mn(e, n, o) {
      ...
      var n = e(b).prev(x);n.length || !s.loopTop && !s.continuousVertical || (n = e(x).last()), n.length && be(n, null, !0);
    }, Hn.moveSectionDown = function () {
      var n = e(b).next(x);n.length || !s.loopBottom && !s.continuousVertical || (n = e(x).first()), n.length && be(n, null, !1);
      ...
      var o = rn(e);"undefined" != typeof n ? cn(e, n) : o.length > 0 && be(o);
      ...
      if (!Vn.hasClass(h)) {
        Yn = !0, requestAnimFrame(function () {
          Yn = !0;
        });var o = oe.outerWidth();Wn = oe.height(), s.resize && Je(Wn, o), e(x).each(function () {
          var n = e(this).find(P),
              o = e(this).find(z);s.verticalCentered && e(this).find(A).css("height", ln(e(this)) + "px"), e(this).css("height", Wn + "px"), s.scrollOverflow && (o.length ? o.each(function () {
            on(e(this));
          }) : on(e(this))), o.length > 1 && Ne(n, n.find(D));
        });var t = e(b),
            i = t.index(x);i && Hn.silentMoveTo(i + 1), Yn = !1, requestAnimFrame(function () {
          Yn = !1;
      ...
      var o = Fn.hasClass(u);n ? o || (Hn.setAutoScrolling(!1, "internal"), Hn.setFitToSection(!1, "internal"), e(E).hide(), Fn.addClass(u)) : o && (Hn.setAutoScrolling(_n.autoScrolling, "internal"), Hn.setFitToSection(_n.autoScrolling, "internal"), e(E).show(), Fn.removeClass(u));
    };var qn,
        On,
        zn,
        Dn = !1,
        ...
        Xn = !0,
        Nn = [],
        Kn = {};Kn.m = { up: !0, down: !0, left: !0, right: !0 }, Kn.k = e.extend(!0, {}, Kn.m);var jn,
        Qn,
        Gn,
        Jn,
        Zn,
        $n,
        _n = e.extend(!0, {}, s);e(this).length && (c(), f());var eo = !1,
        no = 0,
        oo = 0,
        to = 0,
        io = 0,
        lo = 0,
        ao = new Date().getTime();n.requestAnimFrame = function () {
  ...
  };var ie = { afterRender: function afterRender(e) {
      var n = e.find(I),
          o = e.find(c);n.length && (o = n.find(D)), o.mouseover();
